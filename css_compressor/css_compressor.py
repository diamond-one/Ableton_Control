...
try:
	...
	pass
class css_compressor(ControlSurface):
	def __init__(self, c_instance):
		super(css_compressor, self).__init__(c_instance)
	...
	def _mode1_custom_lom_listeners(self, updated_by=False):
		...
		if updated_by not in exclude_list:
			try:
				...
				self.mode1_listener_attach0.add_selected_track_listener(self._mode1_self_song_view_add_selected_track_listener_id_4)
			except:
				pass
		return
	def _remove_mode1_custom_lom_listeners(self, updated_by=False):
		...
		if updated_by not in exclude_list:
			try:
				self.mode1_listener_attach0.remove_selected_track_listener(self._mode1_self_song_view_add_selected_track_listener_id_4)
	...
	def midi_cc_ch_0_val_12_mode1_listener(self, value):
		...
		self.pick_brain(self.threshold_id_6)
		self.pick_brain(self.new_volume_mapping_id_5)
	...
	def midi_cc_ch_0_val_14_mode1_listener(self, value):
		...
		self.pick_brain(self.ratio_id_9)
	...
	def midi_cc_ch_0_val_16_mode1_listener(self, value):
		...
		self.pick_brain(self.release_id_8)
	...
	def midi_cc_ch_0_val_18_mode1_listener(self, value):
		...
		self.pick_brain(self.drywet_id_7)
	...
	def _mode1_configs(self):
		self.mode_1_configs_map = [
			...
			"release_id_8",
			"drywet_id_7",
			"new_volume_mapping_id_5"]
		self.threshold_id_6 = {}
		self.threshold_id_6["attached_to"] = "midi_cc_ch_0_val_12"
		self.threshold_id_6["track"] = self.track_num(2)
		self.threshold_id_6["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[1]"
		self.threshold_id_6["element"] = "value"
		self.threshold_id_6["output_type"] = "val"
		self.threshold_id_6["minimum"] = round(0,2)
		self.threshold_id_6["maximum"] = round(100,2)
		self.threshold_id_6["decimal_places"] = 2
		self.threshold_id_6["ui_listener"] = "value"
		self.threshold_id_6["feedback_brain"] = "feedback_range"
		self.threshold_id_6["ctrl_type"] = "absolute"
		self.threshold_id_6["enc_first"] = 0
		self.threshold_id_6["enc_second"] = 127
		self.threshold_id_6["reverse_mode"] = False
		self.threshold_id_6["takeover_mode"] = "Value scaling"
		self.threshold_id_6["steps"] = 127
		self.threshold_id_6["LED_mapping_type_needs_feedback"] = "1"
		self.threshold_id_6["LED_feedback"] = "default"
		self.threshold_id_6["LED_feedback_active"] = "1"
		self.threshold_id_6["LED_on"] = "127"
		self.threshold_id_6["LED_off"] = "0"
		self.threshold_id_6["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_12"]
		self.threshold_id_6["snap_to"] = True
		self.threshold_id_6["json_id"] = 6
		self.threshold_id_6["mapping_name"] = "Threshold"
		self.threshold_id_6["mapping_type"] = "Parameter"
		self.ratio_id_9 = {}
		self.ratio_id_9["attached_to"] = "midi_cc_ch_0_val_14"
		self.ratio_id_9["track"] = self.track_num(2)
		self.ratio_id_9["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[2]"
		self.ratio_id_9["element"] = "value"
		self.ratio_id_9["output_type"] = "val"
		self.ratio_id_9["minimum"] = round(0,2)
		self.ratio_id_9["maximum"] = round(100,2)
		self.ratio_id_9["decimal_places"] = 2
		self.ratio_id_9["ui_listener"] = "value"
		self.ratio_id_9["feedback_brain"] = "feedback_range"
		self.ratio_id_9["ctrl_type"] = "absolute"
		self.ratio_id_9["enc_first"] = 0
		self.ratio_id_9["enc_second"] = 127
		self.ratio_id_9["reverse_mode"] = False
		self.ratio_id_9["takeover_mode"] = "Value scaling"
		self.ratio_id_9["steps"] = 127
		self.ratio_id_9["LED_mapping_type_needs_feedback"] = "1"
		self.ratio_id_9["LED_feedback"] = "default"
		self.ratio_id_9["LED_feedback_active"] = "1"
		self.ratio_id_9["LED_on"] = "127"
		self.ratio_id_9["LED_off"] = "0"
		self.ratio_id_9["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_14"]
		self.ratio_id_9["snap_to"] = True
		self.ratio_id_9["json_id"] = 9
		self.ratio_id_9["mapping_name"] = "Ratio"
		self.ratio_id_9["mapping_type"] = "Parameter"
		self.release_id_8 = {}
		self.release_id_8["attached_to"] = "midi_cc_ch_0_val_16"
		self.release_id_8["track"] = self.track_num(2)
		self.release_id_8["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[5]"
		self.release_id_8["element"] = "value"
		self.release_id_8["output_type"] = "val"
		self.release_id_8["minimum"] = round(0,2)
		self.release_id_8["maximum"] = round(100,2)
		self.release_id_8["decimal_places"] = 2
		self.release_id_8["ui_listener"] = "value"
		self.release_id_8["feedback_brain"] = "feedback_range"
		self.release_id_8["ctrl_type"] = "absolute"
		self.release_id_8["enc_first"] = 0
		self.release_id_8["enc_second"] = 127
		self.release_id_8["reverse_mode"] = False
		self.release_id_8["takeover_mode"] = "Value scaling"
		self.release_id_8["steps"] = 127
		self.release_id_8["LED_mapping_type_needs_feedback"] = "1"
		self.release_id_8["LED_feedback"] = "default"
		self.release_id_8["LED_feedback_active"] = "1"
		self.release_id_8["LED_on"] = "127"
		self.release_id_8["LED_off"] = "0"
		self.release_id_8["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_16"]
		self.release_id_8["snap_to"] = True
		self.release_id_8["json_id"] = 8
		self.release_id_8["mapping_name"] = "Release"
		self.release_id_8["mapping_type"] = "Parameter"
		self.drywet_id_7 = {}
		self.drywet_id_7["attached_to"] = "midi_cc_ch_0_val_18"
		self.drywet_id_7["track"] = self.track_num(2)
		self.drywet_id_7["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[9]"
		self.drywet_id_7["element"] = "value"
		self.drywet_id_7["output_type"] = "val"
		self.drywet_id_7["minimum"] = round(0,2)
		self.drywet_id_7["maximum"] = round(100,2)
		self.drywet_id_7["decimal_places"] = 2
		self.drywet_id_7["ui_listener"] = "value"
		self.drywet_id_7["feedback_brain"] = "feedback_range"
		self.drywet_id_7["ctrl_type"] = "absolute"
		self.drywet_id_7["enc_first"] = 0
		self.drywet_id_7["enc_second"] = 127
		self.drywet_id_7["reverse_mode"] = False
		self.drywet_id_7["takeover_mode"] = "Value scaling"
		self.drywet_id_7["steps"] = 127
		self.drywet_id_7["LED_mapping_type_needs_feedback"] = "1"
		self.drywet_id_7["LED_feedback"] = "default"
		self.drywet_id_7["LED_feedback_active"] = "1"
		self.drywet_id_7["LED_on"] = "127"
		self.drywet_id_7["LED_off"] = "0"
		self.drywet_id_7["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_18"]
		self.drywet_id_7["snap_to"] = True
		self.drywet_id_7["json_id"] = 7
		self.drywet_id_7["mapping_name"] = "Dry/Wet"
		self.drywet_id_7["mapping_type"] = "Parameter"
		self.new_volume_mapping_id_5 = {}
		self.new_volume_mapping_id_5["attached_to"] = "midi_cc_ch_0_val_12"
		self.new_volume_mapping_id_5["track"] = self.track_num(2)
		self.new_volume_mapping_id_5["module"] = "self.song().view.selected_track.mixer_device.volume"
		self.new_volume_mapping_id_5["element"] = "value"
		self.new_volume_mapping_id_5["output_type"] = "val"
		self.new_volume_mapping_id_5["minimum"] = round(0,2)
		self.new_volume_mapping_id_5["maximum"] = round(85,2)
		self.new_volume_mapping_id_5["decimal_places"] = 2
		self.new_volume_mapping_id_5["ui_listener"] = "value"
		self.new_volume_mapping_id_5["feedback_brain"] = "feedback_range"
		self.new_volume_mapping_id_5["ctrl_type"] = "absolute"
		self.new_volume_mapping_id_5["enc_first"] = 0
		self.new_volume_mapping_id_5["enc_second"] = 127
		self.new_volume_mapping_id_5["reverse_mode"] = False
		self.new_volume_mapping_id_5["takeover_mode"] = "Value scaling"
		self.new_volume_mapping_id_5["steps"] = 127
		self.new_volume_mapping_id_5["LED_mapping_type_needs_feedback"] = "1"
		self.new_volume_mapping_id_5["LED_feedback"] = "default"
		self.new_volume_mapping_id_5["LED_feedback_active"] = "1"
		self.new_volume_mapping_id_5["LED_on"] = "127"
		self.new_volume_mapping_id_5["LED_off"] = "0"
		self.new_volume_mapping_id_5["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_12"]
		self.new_volume_mapping_id_5["snap_to"] = True
		self.new_volume_mapping_id_5["json_id"] = 5
		self.new_volume_mapping_id_5["mapping_name"] = "New Volume mapping "
		self.new_volume_mapping_id_5["mapping_type"] = "Volume"
	def _mode1_self_song_view_add_selected_track_listener_id_4(self):
		try:
			...
			self.log_message("csslog:(compressor) There's a problem with 'Action Block 1' in reaction 'selectCompressor' (from 'Song - selected track' listener) >> ")
	...
	def _mode1_ui_listeners(self):
		try:
			self.threshold_id_6_led = eval(self.threshold_id_6["module"])
			self.threshold_id_6_led.add_value_listener(self.threshold_id_6_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.threshold_id_6["element"]) + " does not exist")
		try:
			self.ratio_id_9_led = eval(self.ratio_id_9["module"])
			self.ratio_id_9_led.add_value_listener(self.ratio_id_9_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.ratio_id_9["element"]) + " does not exist")
		try:
			self.release_id_8_led = eval(self.release_id_8["module"])
			self.release_id_8_led.add_value_listener(self.release_id_8_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.release_id_8["element"]) + " does not exist")
		try:
			self.drywet_id_7_led = eval(self.drywet_id_7["module"])
			self.drywet_id_7_led.add_value_listener(self.drywet_id_7_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.drywet_id_7["element"]) + " does not exist")
		try:
			self.new_volume_mapping_id_5_led = eval(self.new_volume_mapping_id_5["module"])
			self.new_volume_mapping_id_5_led.add_value_listener(self.new_volume_mapping_id_5_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.new_volume_mapping_id_5["element"]) + " does not exist")
	def _remove_mode1_ui_listeners(self):
		try:
			self.threshold_id_6_led.remove_value_listener(self.threshold_id_6_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.threshold_id_6["element"]) + " does not exist")
		try:
			self.ratio_id_9_led.remove_value_listener(self.ratio_id_9_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.ratio_id_9["element"]) + " does not exist")
		try:
			self.release_id_8_led.remove_value_listener(self.release_id_8_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.release_id_8["element"]) + " does not exist")
		try:
			self.drywet_id_7_led.remove_value_listener(self.drywet_id_7_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.drywet_id_7["element"]) + " does not exist")
		try:
			self.new_volume_mapping_id_5_led.remove_value_listener(self.new_volume_mapping_id_5_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.new_volume_mapping_id_5["element"]) + " does not exist")
	def _mode1_fire_all_feedback(self):
		self.threshold_id_6_led_listener()
		self.ratio_id_9_led_listener()
		self.release_id_8_led_listener()
		self.drywet_id_7_led_listener()
		self.new_volume_mapping_id_5_led_listener()
	def threshold_id_6_led_listener(self):
		self.feedback_brain(self.threshold_id_6)
	def ratio_id_9_led_listener(self):
		self.feedback_brain(self.ratio_id_9)
	def release_id_8_led_listener(self):
		self.feedback_brain(self.release_id_8)
	def drywet_id_7_led_listener(self):
		self.feedback_brain(self.drywet_id_7)
	def new_volume_mapping_id_5_led_listener(self):
		self.feedback_brain(self.new_volume_mapping_id_5)	
	################## CORE: Python 3 #################
	...
	def disconnect(self):
		...
		super(css_compressor, self).disconnect()